...
router.delete('/:id', validateUUID, checkValidation, authenticate, authorizeSuperAdmin, candidateController.deleteProfile);

// Document endpoints with file validation
router.get('/:id/documents', validateUUID, checkValidation, authenticate, candidateController.getCandidateDocuments);
